...
if (isset($_POST['clear'])) {
    unset($_SESSION['cart']);
    echo 'cart telah dihapus';
}
?>
<form action="" method="post">
    <button type="submit" name="clear" class="btn btn-danger">Hapus Keranjang</button>
</form>
    <div class="container">
        <h1>Makan di Resto</h1>
        ...
        <div class="container1 sticky-bottom" style="transition: 0.8s;" data-aos="zoom-in-up" style="transition: 1.1s;">
            <div class="line" style="box-shadow: -2px 10px 5px rgba(0, 0, 0, 0.2);">
                <h1>Pesanan Saya - Makan di Resto</h1>
            </div>
            <div class="content">
            ...
            <button class="btn1" style="box-shadow: -2px 10px 5px rgba(0, 0, 0, 0.2); font-family: cursive;">
                <a href="meja.php" style="text-decoration: none; color: white;">Pilih Meja</a>
            </button>
        </div>
        </div>
    </div>
